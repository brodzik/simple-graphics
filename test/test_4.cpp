...
TEST_CASE("Scaling complex shapes")
{
    ...
    img1.add(SimpleGraphics::Rectangle({0}, {0}, {0.5, true}, {0.25, true}));
    img1.add(SimpleGraphics::Rectangle({0.25, true}, {0.25, true}, {0.25, true}, {0.25, true}));
