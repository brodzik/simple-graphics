...
{
    SG::Complex img1;
    img1.add(SG::Circle(SG::Point {100, 100}, 100));
    img1.add(SG::Circle(SG::Point {100, 100}, 50, "#FF0000"));
    img1.add(SG::Circle(SG::Point {100, 100}, 25, "#00FF00", "#0000FF"));
    img1.save("test_6_1.svg");
    ...
    SG::Complex img2;
    img2.add(SG::Ellipse(SG::Point {300, 300}, 50, 150, "#00FF00"));
    img2.add(SG::Rectangle(SG::Point {300, 300}, 100, "none", "#FF00FF"));
    img2.save("test_6_2.svg");
